...
void solve_radiation(int argc, char** argv)
{
    ...
    if (switch_shortwave)
    {
        ...
        Radiation_solver_shortwave rad_sw(gas_concs, switch_cloud_optics, switch_aerosol_optics, "coefficients_sw.nc", "cloud_coefficients_sw.nc", "aerosol_optics_sw.nc");
